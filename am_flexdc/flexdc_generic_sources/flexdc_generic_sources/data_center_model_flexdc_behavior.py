"""CONDOR Set-Transformer used by the FlexDC behavior model.
...
the companion training-utilities module.
"""
...
class FlexDCBehaviorModelConfig:
    ...
    FlexDC features produced by the behavior-model utilities.  The workload encoder remains
