"""Structural and training-utility tests for the FlexDC behavior model.

Run with:
    python test_flexdc_behavior_training.py
"""
...
def test_preassigned_split_and_repeat_group_normalization():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        csv_path = Path(tmp) / "benchmark_training_ready.csv"
...
def main():
    ...
    print("ALL FLEXDC BEHAVIOR-MODEL STRUCTURAL TESTS PASSED")
